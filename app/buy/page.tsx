...
export default function BuyPage() {
  const [filters, setFilters] = useState<SearchFiltersType>({ category: 'buy' });

  const filteredProperties = useMemo(() => {
    return properties.filter(property => {
      if (property.category !== 'buy') return false;
  ...
  const handleSearch = () => {
    console.log('Searching properties for sale with filters:', filters);
  };
