...
export default function CommercialPage() {
  const [filters, setFilters] = useState<SearchFiltersType>({ propertyClass: 'commercial' });

  const filteredProperties = useMemo(() => {
    return properties.filter(property => {
      if (property.propertyClass !== 'commercial') return false;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover prime commercial real estate opportunities for your business growth
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredProperties.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Commercial Properties Found</h3>
            <p className="text-gray-600 mb-4">
              Try adjusting your search filters to see more results.
            </p>
            <button
              onClick={() => setFilters({ propertyClass: 'commercial' })}
